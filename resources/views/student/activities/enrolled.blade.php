...
@section('title', 'Activities Enrolled')
                        ...
                        <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12 live-search-list">
                            ...
                            @foreach($activities as $activity)
                                <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <a href="{{ route('student.activities.enrolled_show', $activity->id) }}"><span class="activity-title center-mobile-100 pull-left">{{ $activity->title }}</span></a>
                                    <span class="student-toggle-on-off pull-right">
                                        <button class="btn btn-link-2" onclick="window.location.assign({{ '"'.route('student.activities.enrolled_show', $activity->id).'"' }})"><i class="fa fa-list-alt"></i> View</button>
                                    </span>
                                </li>
                            @endforeach
