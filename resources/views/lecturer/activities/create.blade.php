	            ...
	            <div>
	                <div class="form-box new-activity">
	                    ...
	                    <div class="form-bottom login-form">
	                        <form role="form" action="{{ route('lecturer.activities.store', ['lecturer' => Auth::id()]) }}" method="POST">

	                        	{!! csrf_field() !!}

	                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
									<label for="form-activity" style="color:#fff;font-weight: normal;">The title must be unique. To distinguish, write the academic year in the title:</label>
	                                <label class="sr-only" for="form-activity">Activity Title</label>
	                                <input type="text" class="form-username form-control" id="form-username" name="title" placeholder="Activity Title">
								...
								<div class="form-group{{ $errors->has('criteria') ? ' has-error' : '' }}">
									<label for="form-activity" style="color:#fff;font-weight: normal;">The selected criteria below are attached to the activity:</label>
		                <select class="form-control select2" multiple="multiple" name="criteria[]" data-placeholder="Enter criteria or select below..." style="width: 100%;">
								...
								<button type="submit" class="submit-activity btn btn-link-2">	<i id="rtt-submit" class="fa fa-sign-in"></i>	Submit</button>
	                        </form>
	                    </div>
	                </div>
	            </div>
