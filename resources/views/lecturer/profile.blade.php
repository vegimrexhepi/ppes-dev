    ...
    <div id="template-with-sidebar" class="lecturer-activities">
        ...
        <div class="top-content lecturer-bg-color">
            ...
            <div class="col-sm-6 col-sm-offset-3 col-lg-5 col-lg-offset-3 col-md-6">
                ...
                @endif
                <div>
                    <div class="form-box new-activity edit-profile-lecturer">
                        <div class="form-top">
                        ...
                        <div class="form-bottom profile-form">
                            <form role="form" action="{{ route('lecturer.postEdit', ['lecturer' => Auth::id()]) }}" method="POST">
                                ...
                                {{-- Password --}}
                                <div class="mr-b-10 form-group{{ $errors->has('current_password') ? ' has-error' : '' }}">
                              ...
                              <div id="change-password-hidden">
                                ...
                                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                    ...
                                    <input type="password" name="password_confirmation" placeholder="Confirm New Password..." class="form-password-confirmation form-control" id="form-password-confirmation">
